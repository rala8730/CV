...
\vspace{-4mm}
\section{Experience}
\cventry{\textnormal{Fall 2016-Present}}{\textnormal{Student Android Developer}}{\textsc{University of Colorado Boulder ATLAS}}{\textnormal{Boulder, CO}}{}{\textnormal{Developing Android Application.}}
...
\begin{tasks}
\task {ALP(Applied Leadership Program),CLP(Core Leadership Program),Graphic Designing,Westminister Public Library(Volunteer in the computer class)2014, CUWIC(Women in Computing)}
\end{tasks}

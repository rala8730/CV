...
\begin{tasks}
\task{ALP(Applied Leadership Program)}
\task{CLP(Core Leadership Program)}
\task{Graphic Designing}
\task{Westminister Public Library(Volunteer in the computer class){2014}}
\end{tasks}
